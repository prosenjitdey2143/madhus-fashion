...
export function VideoGallery() {
  ...
  return (
    <section className="py-24 bg-brand-primary border-t border-brand-text/5">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {videos.map((video) => (
            <div 
              key={video.id} 
              className="group cursor-pointer relative aspect-[9/16] overflow-hidden bg-brand-pale border border-brand-text/5"
            ...
            >
              ...
              {/* Overlay */}
              <div className="absolute inset-0 bg-brand-text/20 group-hover:bg-brand-text/40 transition-colors duration-500" />
